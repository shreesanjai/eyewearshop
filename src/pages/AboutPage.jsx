...
function AboutPage() {
  useEffect(() => {
    document.title = 'The Shree Experience | Shree Eyewear Online Store';
  }, []);
    ...
    <main className="story">
      <section className="story-header">
        ...
        <p className="story-header__text">
          ...
          Elevate your eyewear game with Shree frames.
        </p>
      </section>
      ...
      <section className="story-main">
        ...
        <div className="story-main__panel panel-2 about-us">
          ...
          <p className="story-main__text">
            Shree was born of a simple mission - to create high-quality,
        ...
        <div className="story-main__panel panel-3 eyeglasses">
          ...
          <p className="story-main__text">
            At Shree, we believe that everyone should have access to stylish
