...
export const allProductsCategoryData = {
  documentTitle: 'COLLECTION | Shop all products - Shree Eyewear Store',
  banner: {
    title: 'All Products',
    description:
...
export const eyeglassesCategoryData = {
  documentTitle: 'OPTICAL | Trendy Frames & Styles - Shree Eyewear Store',
  banner: {
    title: 'Optical Shop',
    description:
...
export const sunglassesCategoryData = {
  documentTitle: 'SUNGLASSES | Trendy Frames & Styles - Shree Eyewear Store',
  banner: {
    title: 'Sunnies Store',
    description:
